...
final class RoundingMode
{
     ...
     * cannot be represented at the requested scale, an \ArithmeticError is thrown.
     */
    const UNNECESSARY = 0;
     ...
     * rounds towards the even neighbor.
     *
    ...
    /**
     * @return array - an array containing all the rounding modes defined by the constants of this class
     */
